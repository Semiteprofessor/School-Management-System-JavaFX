 ...
 * @author GeoCodec
 */
public class SS1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            ResultSet resultSet = con.createStatement().executeQuery("SELECT * FROM students WHERE classes = 'SS1'");
    ...
    private void btnSubject(ActionEvent event) throws IOException {
        Parent home = FXMLLoader.load(getClass().getResource("/View/classes/SS1/enterSubject.fxml"));
        Node node = (Node) event.getSource();
        Stage stage = (Stage) node.getScene().getWindow();
        stage.setScene(new Scene(home));
    }
    ...
    private void btnTimeTable(ActionEvent event) throws IOException {
        Parent home = FXMLLoader.load(getClass().getResource("/View/classes/SS1/enterTimeTable.fxml"));
        Node node = (Node) event.getSource();
        Stage stage = (Stage) node.getScene().getWindow();
        stage.setScene(new Scene(home));
    }
    ...
    private void btnScience(ActionEvent event) throws SQLException {
        ...
        String sql = "select * from students WHERE department = 'Science' AND classes = 'SS1'";
        ResultSet rs = null;
        try {
    ...
    private void btnCommercial (ActionEvent event) throws SQLException {
        ...
        String sql = "select * from students WHERE department = 'Commercial' AND classes = 'SS1'";
        ResultSet rs = null;
        try {
            rs = conn.createStatement().executeQuery(sql);
        } catch (SQLException e) {
    ...
    private void btnArt (ActionEvent event){
        ...
        String sql = "select * from students WHERE department = 'Art' AND classes = 'SS1'";
        ResultSet rs = null;
        try {
            rs = conn.createStatement().executeQuery(sql);
        } catch (SQLException e) {
    ...
    private void btnBroadSheet(ActionEvent event) throws IOException {
        Parent home = FXMLLoader.load(getClass().getResource("/View/classes/SS1/enterBroadSheet.fxml"));
        Node node = (Node) event.getSource();
        Stage stage = (Stage) node.getScene().getWindow();
        stage.setScene(new Scene(home));
    }
