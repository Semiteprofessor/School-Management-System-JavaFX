...
public class subjectViewController extends Application {
    private User user;
    ...
    @FXML
    private TextFlow faculty;
    @FXML
    private TextArea co;
    @FXML
    private ComboBox<?> search;

    public subjectViewController() throws IOException {
...
//        primaryStage.setScene(new Scene(courseDescription, 700, 900));
    ...
    public void setData(Parent courseDescription, Course forInfo) throws IOException {
        if (courseDescription == null) {
            courseDescription = FXMLLoader.load(getClass().getResource("/View/Syllabus/fxml/subjectView.fxml"));
            ;
        }
