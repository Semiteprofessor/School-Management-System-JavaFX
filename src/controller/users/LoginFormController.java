            ...
            if(username.startsWith("admin")){
                ...
                try {
                    if (log.Login(username, password)){
                        ...
                        AnchorPane user = FXMLLoader.load(getClass().getResource(("view/Home.fxml")));
                ...
                try {
                    if (log.Login(username, password)){
                        ...
                        AnchorPane user = FXMLLoader.load(getClass().getResource(("/view/users/PrintStudents2.fxml")));
                        login.getChildren().setAll(user);
